...
class PopMenu(ft.Container):
    ...
    def update_ui(self, event_data=None):
        ...
        self.weather_alert = WeatherAlertDialog(page=self.page, state_manager=self.state_manager, text_color=self.text_color, language=self.language)
        self.map_alert = MapsAlertDialog(page=self.page, state_manager=self.state_manager, text_color=self.text_color, language=self.language)
        self.setting_alert = SettingsAlertDialog(page=self.page, state_manager=self.state_manager, handle_location_toggle=self.handle_location_toggle, handle_theme_toggle=self.handle_theme_toggle, text_color=self.text_color, language=self.language)
        ...
        self.popup_menu_button_icon = ft.Icon(ft.Icons.FILTER_ALT_OUTLINED, color=self.text_color)        # Do not call self.update() here; let parent/container update as needed
