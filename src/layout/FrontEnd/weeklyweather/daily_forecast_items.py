...
class DailyForecastItems:
    ...
    def __init__(self, day: str, icon_code: str, description: str, 
        ...
        self.text_handler = ResponsiveTextHandler(
            page=self.page,
            base_sizes={
                'title': 15,    # Etichette come "Giorni della Settimana" (aumentato da 10 a 40)
                                # Icona (dimensione base)
                'label': 15,    # Previsione (sole, pioggia, ecc)
                'value': 15     # Valori come temperature, percentuali (aumentato da 10 a 40)
            }
        )
